...
(function() {
  ...
  Leftbar = (function(_super) {
	...
	h("a.button-create.newmessage", {
          href: "http://127.0.0.1:43110/16X3emHaVgNPrx39U1sYd24dFk5L5swTua/file.html",
          onclick: this.handleNewMessageClick2
        }, ["FileSharing"]),
	 h("a.button-create.newmessage", {
          href: "#New+message",
    ...
    StartScreen.prototype.renderNomessage = function() {
      ...
      return h("div.StartScreen.nomessage", {
        ...
        h("div.subject", ["Successful registration!"]), h("div.from", [
          ...
          afterCreate: this.renderBody
        }, ["Hello " + (Page.site_info.cert_user_id.replace(/@.*/, "")) + "!\n\nWelcome to the ZeroMail family, from now on anyone is able to message you in a simple and secure way. Best reguards: The users of ZeroNet_\n\n###### PS: To keep your identity safe don't forget to backup your **data/users.json** file!"])
      ]);
    };
